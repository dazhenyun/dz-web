 ...
 * @Describe: 一个可以将状态持久化存储在 sessionStorage 中的 Hook 。
 */
...
const Demo2 = () => {
	const [value, setValue] = useSessionStorage("tdued", defaultArray);
...
export default props => {
	...
	return (
		<div>
			...
			<h2>代码演示</h2>
			<h4 className="blueGray">刷新页面后，可以看到输入框中的内容被从 sessionStorage 中恢复了</h4>
			...
			<h4 className="blueGray">useSessionStorage 会自动处理序列化和反序列化的操作</h4>
			<Demo2 />
			<h4 className="blueGray">useSessionStorage 对象操作</h4>
			<Demo3 />

...
class LiquidfillComponent extends PureComponent {
	...
	render() {
		...
		return (
			<>
				<Title title='option配置参考：https://github.com/ecomfe/echarts-liquidfill' />
				<h2>水球图</h2>
				<CodePreviewer code={md1} showCode={false}>
					<div style={{ padding: "20px" }}>
						<Liquidfill theme={theme} option={option1} height={400} />
					</div>
				</CodePreviewer>
				<h2>自定义水球图</h2>
				<CodePreviewer code={md2} showCode={false}>
					<div style={{ padding: "20px" }}>
						<Liquidfill theme={theme} option={option2} height={400} />
					</div>
				</CodePreviewer>
			</>
		);
